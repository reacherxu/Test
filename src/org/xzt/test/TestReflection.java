...
//		System.out.println("===============================================");  
	...
	private static void test() throws ClassNotFoundException {
		...
		System.out.println(superman.getClass().getPackage().getName()+ "\t" + class2.getClass().getName());
		Class<?> c = Class.forName("org.xzt.test.SuperMan");
		System.out.println(c.getPackage().getName()+ "\t" + c.getName());
	}
	...
	{  
		...
		class1 = Class.forName("org.xzt.test.Person");  
	...
	{  
		Class<?> class1 = null;  
		class1 = Class.forName("org.xzt.test.SuperMan");  
